...
dat   <- db.add(dat, sigma2  =  resModel$sigma^2)
...
# 
datXval <- db.locerase(datXval, loctype = "sel")
datXval <- db.locate(datXval, names = nm_var, loctype = "z", flag.locnew = TRUE)
datXval <- db.locate(datXval, names = c("Un", nm_fac), loctype = "f", flag.locnew = TRUE)
datXval <- db.locate(datXval, names = "sigma2", loctype = "v", flag.locnew = TRUE)
datXval = db.locate(datXval,nm_sel,"sel")
