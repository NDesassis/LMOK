...
#source("./Mono.R");type = "mono_flat"; nm_sel = "sel_flat";nm_model = "flat_Mono"
#source("./Mono.R");type = "mono_house"; nm_sel = "sel_house";nm_model = "house_Mono"
#source("./MonoBivar.R");type = "mono_bivar"; nm_sel = "sel_both";nm_model = "MonoBivar"
#source("./M1.R");type = "house"; nm_sel = "sel_house"; nm_model = "house_M1"
source("./M2.R");type = "flat"; nm_sel = "sel_flat"; nm_model = "flat_M2"
# source("./M2.R");type = "house"; nm_sel = "sel_house"; nm_model = "house_M2"
#source("./M3.R");type = "both"; nm_sel = "sel_both";nm_model = "M3"
...
```{r LMOK_kfold, echo=FALSE, eval=FALSE}
...
datXval <- SPDE_LMOK_kfold_compute(datXval, model = m_est, verbose = FALSE, radix = "kfold", mesh = mesh)
...
### Nouvelle version pour les fonctions de validations croisées

```{r LMOK_kfold_new, echo=TRUE, eval=TRUE}
# Creation of the folds for the cross-validation
dat = prepareDb(dat, 
                nm_fac = nm_fac,
                nm_var = nm_var, 
...
# definition de la fonction d'estimation à évaluer
...
# calcul de la validation par K-fold
datXval <- kfold_compute(datXval, fn_estim = fn_estim, radix = "kfold", 
                         verbose = FALSE)

# calcul de la validation par K-fold (on peut calculer les statistiques de l'erreur
# de validation croisée en fonction de la valeur du code)
